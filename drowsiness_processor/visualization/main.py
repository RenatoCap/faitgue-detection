        ...
        if feature == 'micro_sleep' or feature == 'pitch':
            if feature == 'micro_sleep':
                self.draw_report_text(sketch,
                                      f"Evaluando Micro-siestas: Mantente alerta ",
                                      position, color)

            if feature == 'pitch':
                self.draw_report_text(sketch,
                                      f"Evaluando Bostezos: Mantente alerta",
                                      position, color)
        else:
            ...
            if feature == 'eye_rub_first_hand' or feature == 'eye_rub_second_hand':
                self.draw_report_text(sketch,
                                      f"Calculo: Primera mano sobre ojo: {300 - elapsed_time} segundos restantes",
                                      position, color)

            if feature == 'flicker':
                self.draw_report_text(sketch,
                                      f"Calculo: Cabeceo: {60 - elapsed_time} segundos restantes",
                                      position, color)

            if feature == 'yawn':
                self.draw_report_text(sketch,
                                      f"Calculo: Bostezo: {180 - elapsed_time} segundos restantes",
                                      position, color)
